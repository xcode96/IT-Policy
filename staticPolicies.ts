const acceptableEncryptionPolicyContent = `Consensus Policy Resource Community
...
RSA 
2048 
Must use a secure padding scheme. PKCS#7 
...
4.3.1 Key exchanges must use one of the following cryptographic protocols: Diffie
Hellman, IKE, or Elliptic curve Diffie-Hellman (ECDH). 
...
export const STATIC_POLICIES = new Map<string, string>([
    ['Acceptable Encryption Policy', acceptableEncryptionPolicyContent]
]);