      ...
      <nav className="flex-1 overflow-y-auto p-4 space-y-1">
        {filteredPolicies.length > 0 ? (
            ...
            <button
                ...
                className={`w-full group text-left px-4 py-3 text-sm rounded-xl transition-all duration-200 border ${
                selectedPolicyId === policy.id
                    ? 'bg-primary-subtle border-primary-light/30 text-primary-dark font-semibold shadow-sm'
                    : 'bg-transparent border-transparent text-textSecondary hover:bg-slate-50 hover:text-textPrimary'
                }`}
            >
          ...
          <div className="space-y-3">
             <div className="grid grid-cols-4 gap-2">
                <button
                    ...
                    className="col-span-4 flex items-center justify-center gap-2 p-3 text-sm rounded-xl font-bold shadow-lg shadow-primary/20 transition-all duration-200 bg-primary hover:bg-primary-dark text-white active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed group"
                >
                ...
                <button
                    ...
                    disabled={isActionInProgress}
                    className="col-span-1 relative flex flex-col items-center justify-center gap-1 p-2 text-xs rounded-xl transition-all duration-200 bg-white border border-border text-textSecondary hover:border-primary/50 hover:text-primary active:scale-95 shadow-sm"
                    title="Live Sync"
                >
                 ...
                 <button
                    ...
                    disabled={isActionInProgress}
                    className="col-span-1 flex flex-col items-center justify-center gap-1 p-2 text-xs rounded-xl transition-all duration-200 bg-white border border-border text-textSecondary hover:border-primary/50 hover:text-primary active:scale-95 shadow-sm"
                    title="Import JSON"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                 ...
                 <button
                    ...
                    disabled={isActionInProgress}
                    className="col-span-2 flex flex-row items-center justify-center gap-2 p-2 text-xs rounded-xl transition-all duration-200 bg-white border border-border text-textSecondary hover:border-primary/50 hover:text-primary active:scale-95 shadow-sm font-medium"
                    title="Export All"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
