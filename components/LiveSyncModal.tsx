...
const LiveSyncModal: React.FC<LiveSyncModalProps> = ({ onClose, onSync, onDisconnect, syncStatus, syncUrl }) => {
    ...
    return (
        ...
        >
            <div 
                className="bg-surface rounded-xl shadow-xl w-full max-w-lg animate-fade-in overflow-hidden" 
            ...
            >
                ...
                <div className="p-8">
                    <div className="text-sm text-textSecondary bg-gray-50 p-4 rounded-lg border border-border mb-6">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 border border-border rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition bg-background text-textPrimary disabled:bg-gray-100"
                            ...
                            <div>
                                {currentStatus === 'connected' && (
                                    <button
                                        ...
                                        className="px-5 py-2 text-sm font-semibold text-red-700 bg-red-100 rounded-lg hover:bg-red-200 transition-colors duration-200"
                                    >
                                        Disconnect
                                    </button>
                                )}
